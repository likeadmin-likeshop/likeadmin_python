...
from .schemas import (
    {{{ entity_name }}}ListIn, {{{ entity_name }}}DetailIn, {{{ entity_name }}}AddIn, {{{ entity_name }}}EditIn, {{{ entity_name }}}DelIn, {{{ entity_name }}}Out)
...
@unified_resp
async def {{{ module_name }}}_list(list_in: {{{ entity_name }}}ListIn = Depends(),
...
@unified_resp
async def {{{ module_name }}}_detail(detail_in: {{{ entity_name }}}DetailIn = Depends(),
                        {{{ entity_snake_name }}}_service: I{{{ entity_name }}}Service = Depends({{{ entity_name }}}Service.instance)):
    """{{{ function_name }}}详情"""
...
@unified_resp
async def {{{ module_name }}}_add(add_in: {{{ entity_name }}}AddIn,
                     {{{ entity_snake_name }}}_service: I{{{ entity_name }}}Service = Depends({{{ entity_name }}}Service.instance)):
    """{{{ function_name }}}新增"""
...
@unified_resp
async def {{{ module_name }}}_edit(edit_in: {{{ entity_name }}}EditIn,
                      {{{ entity_snake_name }}}_service: I{{{ entity_name }}}Service = Depends({{{ entity_name }}}Service.instance)):
    """{{{ function_name }}}编辑"""
...
@unified_resp
async def {{{ module_name }}}_del(del_in: {{{ entity_name }}}DelIn,
                     {{{ entity_snake_name }}}_service: I{{{ entity_name }}}Service = Depends({{{ entity_name }}}Service.instance)):
    """{{{ function_name }}}删除"""
